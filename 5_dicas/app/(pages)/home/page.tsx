...
export default function Home() {
  ...
  const { jogador, setSala, logout } = useGame();
  ...
  async function criarSala() {
    ...
    try {
        ...
        totalRodadas: 5, // ou o valor selecionado
        });
    ...
    <main className="min-h-screen bg-slate-950 text-white flex items-center justify-center">
      <div className="w-full max-w-lg bg-slate-900 rounded-2xl p-8 flex flex-col gap-6 shadow-lg relative">
        ...
        <div className="relative">
            ...
            className="w-full px-4 py-3 pr-10 rounded-xl bg-slate-800
        ...
        <div className="flex flex-col gap-4 mt-2">
          ...
          <div className="flex gap-2">
            <input
              ...
              className="flex-1 px-4 py-3 rounded-xl bg-slate-800
